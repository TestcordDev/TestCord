...
import { hasPreset, importPresetObject, validatePreset } from "./presets";
...
function ImportModal({ modalProps, onImported }) {
    ...
    return (<ModalRoot {...modalProps} size={"medium" /* ModalSize.MEDIUM */}>
            ...
            <ModalContent className="vc-presets-modal-content">
                ...
                <TextArea className="vc-presets-modal-textarea" value={text} onChange={(v) => { setText(v); setRenameTouched(false); }} placeholder='{ "name": "…", "plugins": { … } }'/>
            ...
            ? (<div className="vc-presets-preview">
                                ...
                                <TextInput value={effectiveName} onChange={(v) => { setRename(v); setRenameTouched(true); }} placeholder="Preset name"/>
                            </div>)
