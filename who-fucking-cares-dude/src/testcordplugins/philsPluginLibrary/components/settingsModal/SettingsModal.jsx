...
export const SettingsModal = (props) => {
    const doneButton = <Button size={Button.Sizes.SMALL} color={Button.Colors.BRAND} onClick={props.onDone}>
    ...
    return (<ModalRoot {...props}>
            ...
            <Flex style={{ justifyContent: "flex-start", alignItems: "center", flex: 1 }}>
                                <ContributorAuthorSummary author={props.author} contributors={props.contributors}/>
                            </Flex>}
                        {props.footerContent}
                    </div>
