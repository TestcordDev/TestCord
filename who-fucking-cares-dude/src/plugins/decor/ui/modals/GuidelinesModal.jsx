...
function GuidelinesModal(props) {
    return (<ConfirmModal {...props} title="Hold on" confirmText="Continue" variant="primary" onConfirm={() => {
            ...
            <div className={DecorationModalClasses.modal}>
                <Paragraph>
                    By submitting a decoration, you agree to <Link href="https://github.com/decor-discord/.github/blob/main/GUIDELINES.md">
                        the guidelines
...
export const openGuidelinesModal = () => requireAvatarDecorationModal().then(() => openModal(props => <GuidelinesModal {...props}/>));
