...
export function SoundTriggerSettings() {
    ...
    return (<Flex flexDirection="column">
            <Flex flexDirection="row">
                <Button style={{ flexGrow: 1 }} disabled={!settingsExist} onClick={() => openTriggerModal({
            mode: "create",
            onSubmit(trigger) {
                ...
                <Flex flexDirection="row">
                    <Button disabled={!settingsExist} onClick={() => openModal((modalProps) => <ImportModal {...modalProps}/>)}>
                        Import
                    </Button>
                    <Button disabled={!settingsExist} onClick={() => {
            ...
            ? settings.store.soundTriggers.map((trigger, i) => (<SoundTriggerEntry key={i} index={i} trigger={trigger} onDelete={i => {
