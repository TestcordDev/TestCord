 ...
 */
export function getNotificationDotState(channelStates, cachedUnreadCounts, shouldUseFallback) {
    ...
    for (const state of channelStates) {
        ...
        if (state.unreadCount > 0 || !shouldUseFallback || !state.hasUnread)
            continue;
...
export function reconcileUnreadFallbackCache(cachedUnreadCounts, channelStates) {
