...
export function NoteSvg() {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 480 720" fill="currentColor" className={cl("music-note")}>
...
const getIndexes = (lyrics, position, delay) => {
...
export function useLyrics({ scroll = true } = {}) {
    ...
    useEffect(() => {
        const handleDelayUpdate = (action) => {
