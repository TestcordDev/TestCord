...
function TriggerContainer({ child }) {
    ...
    if (visible) {
        ...
        return (<div className={className} onClick={() => onClick && setVisible(true)} onMouseEnter={event => {
                if (!onClick) {
...
function FlaggedInput({ index, forceUpdate }) {
    ...
    return (<Flex flexDirection="row">
        ...
        <Button onClick={removeSelf} look={Button.Looks.FILLED} size={Button.Sizes.SMALL} style={{
            padding: 0,
