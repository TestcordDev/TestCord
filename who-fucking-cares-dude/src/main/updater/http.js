...
ipcMain.handle("VencordGetRepo" /* IpcEvents.GET_REPO */, serializeErrors(() => `https://github.com/${gitRemote}`));
ipcMain.handle("VencordGetUpdates" /* IpcEvents.GET_UPDATES */, serializeErrors(calculateGitChanges));
ipcMain.handle("VencordUpdate" /* IpcEvents.UPDATE */, serializeErrors(fetchUpdates));
ipcMain.handle("VencordForceUpdate" /* IpcEvents.FORCE_UPDATE */, serializeErrors(fetchUpdates));
ipcMain.handle("VencordBuild" /* IpcEvents.BUILD */, serializeErrors(applyUpdates));
