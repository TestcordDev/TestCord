...
import { MediaEngineStore } from "../../philsPluginLibrary";
export const AudioSourceSelect = (props) => {
    ...
    return (<Select options={windowPreviews.map(({ name, id }) => ({
            label: name,
            value: id,
        }))} isSelected={value => audioSource === value} select={value => setAudioSource(value)} serialize={() => ""} {...props}/>);
};
