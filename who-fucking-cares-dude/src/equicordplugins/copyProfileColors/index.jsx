...
function getProfileColors(userId, guildId) {
    try {
...
function copyProfileColors(userId, guildId) {
...
const userContextMenuPatch = (children, { user, guildId }) => {
    ...
    children.push(<Menu.MenuItem id="CopyProfileColors" icon={ColorIcon} label="Copy Profile Colors" action={() => copyProfileColors(user.id)}/>);
    if (hasGuildColors && effectiveGuildId) {
        children.push(<Menu.MenuItem id="CopyServerProfileColors" icon={ColorIcon} label="Copy Server Profile Colors" action={() => copyProfileColors(user.id, effectiveGuildId)}/>);
    }
};
