...
function NotesSection(props) {
    ...
    if (!props.visible || !loaded)
        return null;
    return <Section title={getIntlMessage("NOTE")} scrollIntoView={props.autoFocus} headingColor={props.headingColor}>
        <NoteEditor userId={props.user.id} className={classes.note} autoFocus={props.autoFocus} onUpdate={() => { }}/>
    </Section>;
}
