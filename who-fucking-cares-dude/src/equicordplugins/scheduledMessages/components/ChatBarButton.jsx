...
export function setScheduleModeEnabled(value) {
    isScheduleModeEnabled = value;
    stateUpdaters.forEach(updater => updater(value));
}
export const ScheduledMessagesButton = ({ isMainChat }) => {
    ...
    return (<ChatBarButton tooltip={tooltip} onClick={toggleScheduleMode} onContextMenu={e => {
            e.preventDefault();
