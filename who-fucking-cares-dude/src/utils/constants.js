...
// Equicord
export const SUPPORT_CHANNEL_ID = "1434228141123047434";
export const GUILD_ID = "1434211283317690502";
export const EQUICORD_GUILD_ID = "1173279886065029291";
export const EQUICORD_SUPPORT_CHANNEL_ID = "1297590739911573585";
...
export const TESTCORD_GUILD_ID = "1434211283317690502";
...
export const VencordDevsById = /* #__PURE__*/ (() => Object.freeze(Object.fromEntries(Object.entries(Devs)
    .filter(d => d[1].id !== 0n)
    .map(([_, v]) => [v.id, v]))))();
export const EquicordDevsById = /* #__PURE__*/ (() => Object.freeze(Object.fromEntries(Object.entries(EquicordDevs)
    .filter(d => d[1].id !== 0n)
    .map(([_, v]) => [v.id, v]))))();
export const TestcordDevsById = /* #__PURE__*/ (() => Object.freeze(Object.fromEntries(Object.entries(TestcordDevs)
    .filter(d => d[1].id !== 0n)
    .map(([_, v]) => [v.id, v]))))();
