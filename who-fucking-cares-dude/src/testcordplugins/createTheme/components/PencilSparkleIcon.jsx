...
export function PencilSparkleIcon({ width = 24, height = 24, className }) {
    return (<svg width={width} height={height} viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
