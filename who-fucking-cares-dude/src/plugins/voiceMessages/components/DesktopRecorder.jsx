...
const Native = VencordNative.pluginHelpers.VoiceMessages;
export const VoiceRecorderDesktop = ({ setAudioBlob, onRecordingChange }) => {
    ...
    return (<Button onClick={toggleRecording}>
