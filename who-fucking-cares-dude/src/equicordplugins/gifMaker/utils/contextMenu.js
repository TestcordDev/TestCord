...
export function getMediaInfo(props) {
    const msg = props.message;
    const directAttachment = props.attachment;
    ...
    const linkUrl = (props.itemHref ?? props.itemSrc ?? props.src);
...
export function getInitialSize(maxW, maxH, sourceWidth, sourceHeight, storedWidth, storedHeight) {
