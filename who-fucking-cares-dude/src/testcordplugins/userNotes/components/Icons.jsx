...
export function NotesDataIcon(props) {
    return (<svg {...props} className={classes(props.className, "vc-notes-data-icon")} width={props.width ?? 24} height={props.height ?? 24} viewBox="1 1 22 22" fill="none">
            <path stroke="currentColor" strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round" d="M10.0002 4H7.2002C6.08009 4 5.51962 4 5.0918 4.21799C4.71547 4.40973 4.40973 4.71547 5.0918 5.0918C4 5.51962 4 6.08009 4 7.2002V16.8002C4 17.9203 4 18.4801 4.21799 18.9079C4.40973 19.2842 4.71547 19.5905 5.0918 19.7822C5.5192 20 6.07899 20 7.19691 20H16.8031C17.921 20 18.48 20 18.9074 19.7822C19.2837 19.5905 19.5905 19.2839 19.7822 18.9076C20 18.4802 20 17.921 20 16.8031V14M16 5L10 11V14H13L19 8M16 5L19 2L22 5L19 8M16 5L19 8"/>
        </svg>);
}
export const SaveIcon = LazyComponent(() => React.memo(() => {
    return (<svg width="32" height="32" viewBox="-4 -4 32 32">
...
export const RefreshIcon = LazyComponent(() => React.memo(() => {
    return (<svg width="32" height="32" viewBox="-4 -4 32 32" fill="none">
...
export function PopupIcon(props) {
    useSettings(["plugins.TestcordHelper.userAreaButtonIconColor"]);
    const color = getTestcordIconColor("userAreaButtonIconColor")
        ?? getTestcordIconColor("headerBarButtonIconColor")
        ?? ICON_COLOR_FALLBACK;
    return (<svg {...props} className={classes(props.className, "vc-popup-icon")} width={props.width ?? 24} height={props.height ?? 24} viewBox="0 0 24 24">
...
export const CrossIcon = LazyComponent(() => React.memo(() => {
    return (<svg width="32px" height="32px" viewBox="-3.2 -3.2 38.40 38.40">
...
export const ProblemIcon = LazyComponent(() => React.memo(() => {
    return (<svg width="32px" height="32px" viewBox="0 0 1024 1024">
...
export const SuccessIcon = LazyComponent(() => React.memo(() => {
    return (<svg width="32px" height="32px" viewBox="0.55 2.3 15.834375 15.834375">
