...
import pl, { Native, settings } from ".";
import { Providers } from "./Providers";
export default function SongLinker({ url, onResolved }) {
        ...
        {songData ? <Card style={{
                ...
                <div>
                    ...
                    VencordNative.native.openExternal(settings.store.servicesSettings[service].openInNative && Providers[service].native ? songData.links[service].nativeUri : songData.links[service].url);
                                ...
                                <img src={Providers[service].logo} alt={`${Providers[service]} logo`} style={{ width: 16, height: 16, objectFit: "contain", display: "block" }}/>
                            </Button>)}
                    </div>
                </div>
