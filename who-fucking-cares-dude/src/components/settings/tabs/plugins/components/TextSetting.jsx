...
export function TextSetting({ setting, pluginSettings, definedSettings, id, onChange }) {
    ...
    return (<SettingsSection name={setting.displayName} id={id} description={setting.description} error={error}>
            {setting.multiline
            ? <TextArea placeholder={setting.placeholder ?? "Enter a value"} value={state} onChange={handleChange} disabled={isSettingDisabled(definedSettings, setting)} {...setting.componentProps}/>
            : <TextInput type="text" placeholder={setting.placeholder ?? "Enter a value"} value={state} onChange={handleChange} maxLength={null} disabled={isSettingDisabled(definedSettings, setting)} {...setting.componentProps}/>}
        </SettingsSection>);
}
