...
if (location.protocol !== "data:") {
    invoke("VencordInitFileWatchers" /* IpcEvents.INIT_FILE_WATCHERS */);
    if (IS_DISCORD_DESKTOP) {
        webFrame.executeJavaScript(sendSync("VencordPreloadGetRendererJs" /* IpcEvents.PRELOAD_GET_RENDERER_JS */));
