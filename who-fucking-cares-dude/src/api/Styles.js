...
export function requireStyle(name) {
 ...
 */
export function enableStyle(name) {
 ...
 * @see {@link enableStyle} for info on getting the name of an imported style
 */
export const toggleStyle = (name) => isStyleEnabled(name) ? disableStyle(name) : enableStyle(name);
/**
 * @param name The name of the style
 * @returns Whether the style is enabled
 * @see {@link enableStyle} for info on getting the name of an imported style
 */
export const isStyleEnabled = (name) => requireStyle(name).dom?.isConnected ?? false;
 ...
 * @see {@link enableStyle} for info on getting the name of an imported style
 */
export const setStyleClassNames = (name, classNames, recompile = true) => {
    const style = requireStyle(name);
 ...
 */
export const compileStyle = (style) => {
    if (!style.dom)
        throw new Error("Style has no DOM element");
