...
function showIcon() {
    ...
    const handleKeys = useCallback((e) => {
        const isMatchingKey = e.code === keyBind &&
            (!reqCtrl || e.ctrlKey) &&
            (!reqShift || e.shiftKey) &&
            (!reqAlt || e.altKey);
...
const settings = definePluginSettings({
    keyBind: {
        ...
        default: "KeyZ",
        isValid: (value) => validKeycodes.includes(value),
    },
    reqCtrl: {
...
export default definePlugin({
    ...
    TrashIcon: channel => {
        const show = showIcon();
        if (!show || !PermissionStore.can(PermissionsBits.MANAGE_CHANNELS, channel))
            return null;
        return (<span onClick={() => RestAPI.del({ url: Constants.Endpoints.CHANNEL(channel.id) })}>
                <svg width="16" height="16" fill="none" viewBox="0 0 24 24" color="#ed4245">
                    ...
                    <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d="M5.06 7a1 1 0 0 0-1 1.06l.76 12.13a3 3 0 0 0 3 2.81h8.36a3 3 0 0 0 3-2.81l.75-12.13a1 1 0 0 0-1-1.06H5.07ZM11 12a1 1 0 1 0-2 0v6a1 1 0 1 0 2 0v-6Zm3-1a1 1 0 1 1 1 1v6a1 1 0 1 1-2 0v-6a1 1 0 0 1 1-1Z"/>
                </svg>
            </span>);
    }
});
