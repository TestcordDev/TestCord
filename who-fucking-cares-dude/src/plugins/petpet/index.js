...
const FRAMES = 10;
const getFrames = makeLazy(() => Promise.all(Array.from({ length: FRAMES }, (_, i) => loadImage(`https://raw.githubusercontent.com/VenPlugs/petpet/main/frames/pet${i}.gif`))));
...
function applyPaletteTransparent(data, palette, cache, threshold) {
    ...
    commands: [
        {
            ...
            execute: async (opts, cmdCtx) => {
                ...
                if (delay < 20)
                    return sendBotMessage(cmdCtx.channel.id, { content: "Delay must be at least 20." });
