 ...
 */
export async function uploadToNest(_, fileBuffer, filename, authToken) {
    try {
...
export async function uploadToEzHost(_, fileBuffer, filename, key) {
    try {
        const formData = new FormData();
        formData.append("file", new Blob([fileBuffer]), filename);
...
export async function uploadTo0x0(_, fileBuffer, filename) {
    try {
        const formData = new FormData();
        formData.append("file", new Blob([fileBuffer]), filename);
...
export async function uploadToS3(_, fileBuffer, uploadUrl, headers) {
    try {
...
export async function uploadToCatbox(_, fileBuffer, filename, userhash) {
    try {
        const formData = new FormData();
...
export async function uploadToLitterbox(_, fileBuffer, filename, expiry) {
    try {
        const formData = new FormData();
        formData.append("reqtype", "fileupload");
...
export async function uploadToGofile(_, fileBuffer, filename, token) {
    try {
        const formData = new FormData();
        if (token?.trim()) {
...
export async function uploadToTmpfiles(_, fileBuffer, filename) {
    try {
        const formData = new FormData();
        formData.append("file", new Blob([fileBuffer]), filename);
...
export async function uploadToBuzzheavier(_, fileBuffer, filename) {
    try {
...
export async function uploadToTempSh(_, fileBuffer, filename) {
    try {
        const formData = new FormData();
        formData.append("file", new Blob([fileBuffer]), filename);
...
export async function uploadToFilebin(_, fileBuffer, filename) {
    try {
...
export async function uploadToPixelVault(_, fileBuffer, filename, uploadKey) {
    try {
        const formData = new FormData();
        formData.append("file", new Blob([fileBuffer]), filename);
...
export async function uploadToPixelDrain(_, fileBuffer, filename, apiKey) {
    try {
        const headers = {};
        if (apiKey?.trim()) {
...
export async function uploadToWebdav(_, fileBuffer, uploadUrl, headers) {
...
export async function createWebdavShare(_, ocsUrl, headers, body) {
...
export async function fetchFile(_, url) {
    try {
