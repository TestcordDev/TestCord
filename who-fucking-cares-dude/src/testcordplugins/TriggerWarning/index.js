...
export default definePlugin({
    ...
    settings,
    _spoilerFilenames: [],
    _spoilerFilenamesRaw: undefined,
    _spoilerLinks: [],
    _spoilerLinksRaw: undefined,
    _getSpoilerFilenames() {
        const raw = settings.store.spoilerFilenames;
        if (raw === this._spoilerFilenamesRaw)
    ...
    spoilerLink(alreadySpoilered, link, type) {
        if (alreadySpoilered)
            return alreadySpoilered;
        if (!link)
            return null;
