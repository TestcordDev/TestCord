...
(function (ModalType) {
    ModalType["Lock"] = "Lock";
    ModalType["Unlock"] = "Unlock";
    ModalType["Access"] = "Access";
})(ModalType || (ModalType = {}));
const cl = classNameFactory("vc-password-modal-");
export function PasswordModal({ channelId, type, callback, modalProps }) {
            ...
            <form onSubmit={onSubmit}>
                <ModalContent className={cl("content")}>
                    <Forms.FormSection>
                        ...
                        <TextInput type="password" value={password} onChange={e => setPassword(e)}/>
                    </Forms.FormSection>
                    {[ModalType.Lock, ModalType.Unlock].includes(type) && (<Forms.FormSection>
                            <Forms.FormTitle>Confirm Password</Forms.FormTitle>
                            <TextInput type="password" value={confirmPasswordValue} onChange={e => setConfirmPasswordValue(e)}/>
                        </Forms.FormSection>)}
                    <Forms.FormDivider {...{}}/>
