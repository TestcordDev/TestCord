...
const format = (date, formatTemplate) => {
    ...
    formats: {
        ...
        component: componentProps => {
            ...
            return (<>
                    ...
                    {Object.entries(timeFormats).map(([key, value]) => (<section key={key}>
                            {key === "sameDayFormat" && (<div className={Margins.bottom20}>
...
export default definePlugin({
    ...
    settings,
    settingsAboutComponent: () => (<div className={"vc-cmt-info-card"}>
