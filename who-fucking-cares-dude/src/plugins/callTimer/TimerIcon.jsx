 ...
 */
export function TimerIcon({ height = 16, width = 16, className }) {
    return (<svg viewBox="0 0 455 455" height={height} width={width} className={className} style={{ color: "var(--channels-default)" }}>
