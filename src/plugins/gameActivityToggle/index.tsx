...
function Icon({ className }: { className?: string; }) {
    ...
    return (
        <svg className={className} width="20" height="20" viewBox="0 0 24 24">
            <path
                fill={!showCurrentGame && !oldIcon ? "var(--vc-plugin-icon-color, var(--status-danger))" : "var(--vc-plugin-icon-color, currentColor)"}
            ...
            />
            {!showCurrentGame && <>
                <path fill="var(--vc-plugin-icon-color, var(--status-danger))" d={redLinePath} />
