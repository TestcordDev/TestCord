...
export function showInstallFinishedAlert(pluginToEnable, native) {
    Alerts.show({
        title: "Done!",
        body: `${pluginToEnable} has been successfully installed. However, as it makes use of native functions, a client restart is required. What now?`,
