...
export default definePlugin({
    ...
    renderMessageAccessory({ message }) {
        ...
        return (<div className="tidal-embed">
                <iframe src={src} width={width} height={height} allow="encrypted-media" sandbox="allow-same-origin allow-scripts allow-forms allow-popups" title="TIDAL Embed Player"/>
            </div>);
    }
});
