 ...
 */
export function ExpandableSection({ children, renderContent: Content, className, initialExpanded = false }) {
    const [expanded, setExpanded] = useState(initialExpanded);
    const Icon = expanded ? DownArrow : RightArrow;
    return (<Card data-expanded={expanded} className={classes("vc-expandable-card", className)}>
