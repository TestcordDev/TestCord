...
export const UserSettingsDefinitions = proxyLazyWebpack(() => {
 ...
 */
export function getUserSettingDefinition(group, name) {
 ...
 * @param name The name of the setting
 */
export function getUserSettingDefinitionLazy(group, name) {
    return proxyLazy(() => getUserSettingDefinition(group, name));
}
