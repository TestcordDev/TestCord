...
export let currentShape = "rectangle";
export function setShape(shape) {
    currentShape = shape;
}
export let shapeFill = false;
export function setShapeFill(fill) {
    shapeFill = fill;
}
export const ShapeTool = {
    ...
    draw(canvas = shapeCanvas) {
        ...
        switch (currentShape) {
            case "rectangle":
                if (shapeFill)
                    canvas.fillRect(this.draggingFrom.x, this.draggingFrom.y, Mouse.x - this.draggingFrom.x, Mouse.y - this.draggingFrom.y);
                else
                    canvas.strokeRect(this.draggingFrom.x, this.draggingFrom.y, Mouse.x - this.draggingFrom.x, Mouse.y - this.draggingFrom.y);
                break;
            case "ellipse":
