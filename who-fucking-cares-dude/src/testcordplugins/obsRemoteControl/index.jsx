...
const settings = definePluginSettings({
    ...
    separator: {
        ...
        component: () => (<div className="vc-obsremotecontrol-separator"/>),
        hidden: IS_WEB
    },
    startApp: {
...
async function onVoiceChannelSelect({ guildId, channelId, currentVoiceChannelId }) {
...
function isJoining(channelId, currentVoiceChannelId) {
    return channelId && !currentVoiceChannelId;
}
function isLeaving(channelId, currentVoiceChannelId) {
    return !channelId && currentVoiceChannelId;
}
function isSwitching(channelId, currentVoiceChannelId) {
    return channelId && currentVoiceChannelId;
}
