...
function TimeDeleteIcon({ height = 20, width = 20, className, color = "currentColor" }) {
...
function TimeDeleteButton() {
    ...
    const ButtonIcon = (props) => (<TimeDeleteIcon {...props} color={isActive ? ACTIVE_ICON_COLOR : props.color}/>);
    return (<HeaderBarButton icon={ButtonIcon} tooltip={isActive ? "timeDelete: ON" : "timeDelete: OFF"} aria-label="Toggle timeDelete" selected={isActive} onClick={() => {
