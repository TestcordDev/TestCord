...
export const screenshareStoreDefault = (set, get) => ({
...
export let screenshareStore;
export const initScreenshareStore = () => screenshareStore = createPluginStore(PluginInfo.PLUGIN_NAME, "ScreenshareStore", profileable(screenshareStoreDefault, { name: "" }, Object.values(defaultScreenshareProfiles)));
