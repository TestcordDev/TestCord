...
export function DecModal(props) {
    const encryptedMessage = props?.message?.content;
    ...
    return (<Modal {...props} size="sm" title="Decrypt Message" actions={[
            {
                text: "Decrypt",
                variant: "primary",
                onClick: onDecrypt
...
export function buildDecModal(msg) {
    openModal((props) => <DecModal {...props} {...msg}/>);
}
