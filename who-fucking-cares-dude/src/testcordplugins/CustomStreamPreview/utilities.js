...
const ChannelTypeToStreamPrefix = {
    1: "call", // DM
    2: "guild", // Guild voice
    3: "call", // Group DM
...
export const getStreamingState = () => Boolean(ApplicationStreamingStore.getCurrentUserActiveStream());
// ── Saved preview image (DataStore) ───────────────────────────────────────────
export const getSavedPreview = async () => (await DataStore.get(PREVIEW_IMAGE_KEY)) ?? null;
export const savePreview = (image) => DataStore.set(PREVIEW_IMAGE_KEY, image);
export const clearSavedPreview = () => DataStore.del(PREVIEW_IMAGE_KEY);
// ── Stream key handling ───────────────────────────────────────────────────────
 ...
 */
export const startSendingPreview = (image) => {
    stopSendingPreview();
...
export const stopSendingPreview = () => {
...
export const isSendingPreview = () => resendIntervalId !== null || pendingTimeoutId !== null;
