...
export default definePlugin({
    ...
    shouldShowGitHub(userId) {
        return UserProfileStore.getUserProfile(userId)?.connectedAccounts?.some((c) => c.type === "github") ?? false;
    },
    ...
    renderProfileRepositoriesTab: ErrorBoundary.wrap((props) => {
