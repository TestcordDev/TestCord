...
const pluginSettings = definePluginSettings(Object.entries(UrlReplacementRules).reduce((acc, [key, rule]) => {
    acc[key] = {
...
const Native = VencordNative.pluginHelpers.OpenInApp;
export default definePlugin({
    ...
    handleAccountView(e, platformType, userId) {
