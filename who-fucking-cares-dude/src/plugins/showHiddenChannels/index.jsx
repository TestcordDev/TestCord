...
export const settings = definePluginSettings({
    channelStyle: {
        ...
        options: [
            { label: "Classic", value: 0 /* ChannelStyle.Classic */, default: true },
            { label: "Muted", value: 1 /* ChannelStyle.Muted */ },
            { label: "Show Unreads", value: 2 /* ChannelStyle.Unread */ },
            { label: "Muted and Show Unreads", value: 3 /* ChannelStyle.MutedUnread */ }
        ],
        restartNeeded: true
    },
    showMode: {
        ...
        type: 4 /* OptionType.SELECT */,
        options: [
            { label: "Lock Icon replacing channel icon", value: 0 /* ShowMode.LockIcon */, default: true },
            { label: "Eye icon on the right", value: 2 /* ShowMode.EyeIconRight */ },
            { label: "Lock icon on the right", value: 1 /* ShowMode.LockIconRight */ }
        ],
        restartNeeded: true
    },
...
function isUncategorized(objChannel) {
...
export default definePlugin({
    ...
    patches: [
        ...
        },
        {
            ...
            predicate: () => settings.store.showMode === 0 /* ShowMode.LockIcon */,
            replacement: {
                // Lock Icon
        ...
        },
        {
            ...
            replacement: [
                ...
                {
                    predicate: () => settings.store.showMode === 2 /* ShowMode.EyeIconRight */,
                ...
                {
                    predicate: () => settings.store.showMode === 1 /* ShowMode.LockIconRight */,
                    match: /\.Children\.count.+?:null(?<=,channel:(\i).+?)/,
        ...
        {
            find: "UNREAD_IMPORTANT:",
            predicate: () => settings.store.channelStyle === 1 /* ChannelStyle.Muted */ || settings.store.channelStyle === 3 /* ChannelStyle.MutedUnread */,
            replacement: [
        ...
        {
            find: "UNREAD_IMPORTANT:",
            predicate: () => settings.store.channelStyle !== 2 /* ChannelStyle.Unread */ && settings.store.channelStyle !== 3 /* ChannelStyle.MutedUnread */,
            replacement: [
                {
    ...
    LockIcon: ErrorBoundary.wrap(() => (<svg className={cl("channel-list-icon")} height="18" width="20" viewBox="0 0 24 24" aria-hidden={true} role="img">
            <path fillRule="evenodd" d="M17 11V7C17 4.243 14.756 2 12 2C9.242 2 7 4.243 7 7V11C5.897 11 5 11.896 5 13V20C5 21.103 5.897 22 7 22H17C18.103 22 19 21.103 19 20V13C19 11.896 18.103 11 17 11ZM12 18C11.172 18 10.5 17.328 10.5 16.5C10.5 15.672 11.172 15 12 15C12.828 15 13.5 15.672 13.5 16.5C13.5 17.328 12.828 18 12 18ZM15 11H9V7C9 5.346 10.346 4 12 4C13.654 4 15 5.346 15 7V11Z"/>
        </svg>), { noop: true }),
    EyeRightIcon: ErrorBoundary.wrap(() => (<Tooltip text="Hidden Channel">
            {({ onMouseLeave, onMouseEnter }) => (<svg onMouseLeave={onMouseLeave} onMouseEnter={onMouseEnter} className={classes(cl("channel-list-icon"), cl("hidden-channel-icon"))} width="24" height="24" viewBox="0 0 24 24" aria-hidden={true} role="img">
    ...
    LockRightIcon: ErrorBoundary.wrap(() => (<Tooltip text="Hidden Channel">
            {({ onMouseLeave, onMouseEnter }) => (<svg onMouseLeave={onMouseLeave} onMouseEnter={onMouseEnter} className={cl("channel-list-icon") + " " + "shc-hidden-channel-icon"} width="24" height="24" viewBox="0 0 24 24" aria-hidden={true} role="img">
