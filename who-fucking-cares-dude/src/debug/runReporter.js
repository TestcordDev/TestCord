...
async function runReporter() {
    ...
    try {
        ...
        for (const [searchType, args] of Webpack.lazyWebpackSearchHistory) {
            ...
            if (searchType === "findComponent")
                method = "find";
            if (searchType === "findExportedComponent")
                method = "findByProps";
            ...
            try {
                ...
                if (result == null || (result.$$vencordGetWrappedComponent != null && result.$$vencordGetWrappedComponent() == null))
                    throw new Error("Webpack Find Fail");
            }
            catch (e) {
