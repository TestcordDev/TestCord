...
export default function ReplyNavigator({ replies }) {
    ...
    return (<ErrorBoundary>
            ...
            display: visible ? "flex" : "none",
                ...
                <Paginator className={"vc-findreply-paginator"} currentPage={page} maxVisiblePages={5} pageSize={1} totalCount={replies.length} onPageChange={processPageChange}/>
                <CloseButton className={"vc-findreply-close"} onClick={() => setVisible(false)}/>
            </div>
        </ErrorBoundary>);
    function processPageChange(page) {
        setPage(page);
