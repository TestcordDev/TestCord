...
export default function DecorSection({ hideTitle = false, hideDivider = false, noMargin = false, useNewSection = false }) {
    ...
    return (<Section {...sectionProps}>
            ...
            if (!authorization.isAuthorized()) {
                ...
                {selectedDecoration && authorization.isAuthorized() && (<Button onClick={() => selectDecoration(null)} variant="secondary" size="small">
                        {removeLabel}
                    </Button>)}
            </Flex>
        </Section>);
