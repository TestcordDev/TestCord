...
import { createTab, handleChannelSwitch, settings } from "./util";
const contextMenuPatch = (children, props) => {
    const { channel, messageId } = props;
    const menuItem = (<Menu.MenuItem label="Open in New Tab" id="open-link-in-tab" action={() => createTab({
...
export default definePlugin({
    ...
    render({ currentChannel, children }) {
        const tabsContainer = (<ErrorBoundary>
    ...
    handleNavigation(guildId, channelId) {
