...
function BackupAndRestoreTab() {
    ...
    return (<SettingsTab>
            ...
            <Flex gap="8px" style={{ flexWrap: "wrap" }}>
                <Button onClick={() => downloadSettingsBackup("all", { forceDataStore: settings.experimentalDataStoreExport })} size="small" variant="secondary">
                    Export All Settings
                </Button>
                ...
                <Button onClick={() => downloadSettingsBackup("datastore", { forceDataStore: settings.experimentalDataStoreExport })} size="small">
                    Export DataStore
                </Button>
            </Flex>
            ...
            <FormSwitch title="Large DataStore Export" description="Force export and import of DataStore even when it's too large. Uses chunked processing to avoid memory issues but may still fail on extremely large datasets." value={settings.experimentalDataStoreExport} onChange={(v) => settings.experimentalDataStoreExport = v}/>
        </SettingsTab>);
}
