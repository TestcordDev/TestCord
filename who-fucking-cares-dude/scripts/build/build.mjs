...
const buildConfigs = [
    // Discord Desktop main & renderer & preload
    {
        ...
        footer: {
            js: "//# sourceURL=file:///VencordPatcher\n" +
    ...
    },
    {
        ...commonOpts,
        entryPoints: [
            join(dirname(fileURLToPath(import.meta.url)), "../../src/Vencord.ts"),
        ],
    ...
    },
    {
        ...
        footer: {
            js: "//# sourceURL=file:///VencordPreload\n" +
    ...
    // Vencord Desktop main & renderer & preload
    {
        ...
        footer: {
            js: "//# sourceURL=file:///VencordDesktopMain\n" +
    ...
    },
    {
        ...
        target: ["esnext"],
        footer: {
            js: "//# sourceURL=file:///VencordDesktopRenderer\n" +
                sourceMapFooter("renderer"),
        },
        globalName: "Vencord",
        sourcemap,
