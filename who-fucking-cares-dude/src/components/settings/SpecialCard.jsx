...
export function SpecialCard({ title, subtitle, description, cardImage, backgroundImage, backgroundColor, buttonTitle, buttonOnClick: onClick, children }) {
    const cardStyle = {
        backgroundColor: backgroundColor || "#9c85ef",
        backgroundImage: `url(${backgroundImage || ""})`,
    };
    return (<Card className={cl("card", "card-special")} style={cardStyle}>
            <div className={cl("card-flex")}>
                ...
                {cardImage && (<div className={cl("image-container")}>
