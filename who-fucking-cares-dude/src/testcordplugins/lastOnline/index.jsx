...
const recentlyOnlineList = new Map();
...
async function loadOnlineList() {
    try {
        const storedData = await DataStore.get(DATASTORE_KEY);
...
function handlePresenceUpdate(status, userId) {
    let changed = false;
    if (recentlyOnlineList.has(userId)) {
...
export default definePlugin({
    ...
    shouldShowRecentlyOffline(user) {
