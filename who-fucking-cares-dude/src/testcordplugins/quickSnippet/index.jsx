...
const AppendButton = ErrorBoundary.wrap(function AppendButton(props) {
    const { code, context } = props;
    const [appended, setAppended] = useState(false);
    if (code.lang.toLowerCase() !== "css" || !settings.store.whitelistChannels.includes(context.channelId || "undefined") && !settings.store.whitelistChannels.includes("all"))
        return null;
    return <Button look={Button.Looks.FILLED} onClick={() => {
            let trimedMessage = "";
...
export default definePlugin({
    ...
    AppendButton: (code, context) => <AppendButton code={code} context={context}/>
});
