...
export function WindowsMaterialSettings() {
    ...
    if (!IS_WINDOWS || IS_WEB || !VencordNative.native.supportsWindowsMaterial())
        return null;
    return (<ErrorBoundary noop>
            ...
            <Select placeholder="None" options={[
            {
                label: "None",
                value: "none",
                default: true
        ...
        ]} closeOnSelect={true} select={v => (settings.windowsMaterial = v)} isSelected={v => v === settings.windowsMaterial} serialize={s => s}/>
        </ErrorBoundary>);
}
