...
export default definePlugin({
    ...
    ForwardFooter(message) {
        ...
        return <div className={cl("footer")}>
            {guild_id && <>
                    {guild_id !== SelectedGuildStore.getGuildId() && <Popout position="top" renderPopout={() => <ServerProfileComponent guildId={guild_id}/>} targetElementRef={popoutRef}>
