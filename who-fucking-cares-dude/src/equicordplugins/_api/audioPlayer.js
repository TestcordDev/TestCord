 ...
 */
import { audioProcessorFunctions, AudioType, identifyAudioType, playAudio } from "@api/AudioPlayer";
...
export default definePlugin({
    ...
    buildPlayer(player, options = {}, audio, unused, internalVolume, channel) {
