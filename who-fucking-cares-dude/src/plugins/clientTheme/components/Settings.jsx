...
function setDiscordTheme(theme) {
...
export function ThemeSettingsComponent() {
    ...
    return (<div className={cl("settings")}>
            <div className={cl("container")}>
                ...
                <ColorPicker color={parseInt(settings.store.color, 16)} onChange={onPickColor} showEyeDropper={false} suggestedColors={colorPresets}/>
            </div>
...
export function ResetThemeColorComponent() {
    return (<Button onClick={() => onPickColor(0x313338)}>
            Reset Theme Color
        </Button>);
}
