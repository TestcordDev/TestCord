...
const messageContextMenuPatch = (children, props) => {
    ...
    if (!message)
        return;
    children.push(<Menu.MenuItem id="export-message" label="Export Message" icon={() => (<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/>
                </svg>)} action={() => exportMessage(message)}/>);
};
...
function getUsernames(contacts, type) {
    return contacts
    ...
    patches: [
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: '$1?($2==="Friends"?[...$3,$self.addExportButton()]:$3):null'
            }
        }
    ],
