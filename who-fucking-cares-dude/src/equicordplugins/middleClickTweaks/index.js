...
function updateListeners(refresh = true) {
...
function handleAuxClick(event) {
    ...
    const media = target?.closest("a[href][data-role='img'], a[href][data-role='video']");
...
const settings = definePluginSettings({
    ...
    pasteThreshold: {
        ...
        default: 100,
        onChange(newValue) { if (newValue < 1) {
