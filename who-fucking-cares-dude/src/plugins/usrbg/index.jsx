...
export default definePlugin({
    ...
    data: null,
    settingsAboutComponent: () => (<Button variant="link" className={cl("settings-button")} onClick={() => VencordNative.native.openExternal("https://github.com/AutumnVN/usrbg#how-to-request-your-own-usrbg-banner")}>
    ...
    getImageUrl(userId) {
        if (!this.userHasBackground(userId))
            return null;
