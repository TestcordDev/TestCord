...
function OutputDeviceComponent() {
    ...
    return (<>
            ...
            <Select options={Object.values(configModule.getOutputDevices()).map((device /* i am NOT typing this*/) => {
...
function InputDeviceComponent() {
    ...
    return (<div style={{ marginTop: "10px" }}>
            ...
            <Select options={Object.values(configModule.getInputDevices()).map((device /* i am NOT typing this*/) => {
...
function VideoDeviceComponent() {
    ...
    return (<div style={{ marginTop: "10px" }}>
            ...
            <Select options={Object.values(configModule.getVideoDevices()).map((device /* i am NOT typing this*/) => {
