...
export const useAuthorizationStore = proxyLazy(() => zustandCreate(zustandPersist((set, get) => ({
    ...
    async authorize() {
        return new Promise((resolve, reject) => {
            ...
            openModal(props => <OAuth2AuthorizeModal {...props} scopes={["identify"]} responseType="code" redirectUri={AUTHORIZE_URL} permissions={0n} clientId={CLIENT_ID} cancelCompletesFlow={false} callback={async (response) => {
