...
export const settings = definePluginSettings({
    ...
    attachmentFileExtensions: {
        ...
        onChange: (value) => {
            ...
            Native.updateAllowedExtensions(processedValue).catch((err) => {
    ...
    imageCacheDir: {
        ...
        component: ErrorBoundary.wrap(ImageCacheDir)
    },
    logsDir: {
        type: 6 /* OptionType.COMPONENT */,
        description: "Select logs directory",
        component: ErrorBoundary.wrap(LogsDir)
    },
    importLogs: {
        type: 6 /* OptionType.COMPONENT */,
    ...
    openLogs: {
        ...
        component: () => <Button onClick={() => openLogModal()}>
                Open Logs
            </Button>
    },
    openImageCacheFolder: {
        ...
        component: () => <Button disabled={IS_WEB
                || settings.store.imageCacheDir == null
                || settings.store.imageCacheDir === DEFAULT_IMAGE_CACHE_DIR} onClick={() => Native.showItemInFolder()}>
    ...
    clearLogs: {
        ...
        component: () => <Button variant="dangerPrimary" onClick={() => Alerts.show({
                title: "Clear Logs",
