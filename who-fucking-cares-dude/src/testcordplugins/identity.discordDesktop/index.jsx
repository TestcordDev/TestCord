...
const native = VencordNative.pluginHelpers.Identity;
...
async function SaveData() {
    ...
    const extraUserObject = { extraUserObject: UserStore.getCurrentUser() };
...
function ResetCard() {
    return (<CustomizationSection title={"Identity"} hasBackground={true} hideDivider={false}>
            <Flex>
                <Button onClick={() => {
            Alerts.show({
                title: "Hold on!",
            ...
            Alerts.show({
                ...
                <Button onClick={SetNewData} size={Button.Sizes.MEDIUM}>
                    Randomise
                </Button>
            </Flex>
