            ...
            <div className={cl("color-modal")}>
                <div>
                    ...
                    <div className={cl("color")}>
                        <ColorPicker color={parseHexToNumber(furColor) ?? 16777215} onChange={handleFurColorChange} showEyeDropper={true}/>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className={cl("color")}>
                        <ColorPicker color={parseHexToNumber(outlineColor) ?? 0} onChange={handleOutlineColorChange} showEyeDropper={true}/>
                    </div>
                </div>
            </div>
        </div>);
...
const settings = definePluginSettings({
    ...
    speed: {
        ...
        default: 10,
        isValid: (value) => value >= 0 || "Speed must be bigger than 0",
        onChange: load,
    },
    fps: {
        ...
        type: 1 /* OptionType.NUMBER */,
        default: 24,
        isValid: (value) => value > 0 || "Framerate must be bigger than 0",
        onChange: load
    },
    // Oneko Specific
    onekoSection: {
    ...
    size: {
        ...
        type: 1 /* OptionType.NUMBER */,
        default: 120,
        isValid: (value) => value > 0 || "Size must be bigger than 0",
        onChange: load
    },
    fade: {
...
function load() {
    if (!isPluginEnabled("CursorBuddy"))
        return;
    unload();
