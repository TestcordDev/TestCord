...
export function NoteSvg(className) {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 480 720" fill="currentColor" className={className}>
...
const calculateIndexes = (lyrics, position, delay) => {
