...
export let FFmpegStateContext;
waitFor("createContext", () => {
    FFmpegStateContext = React.createContext(undefined);
});
export async function loadFFmpeg(ffmpeg, setLoaded) {
