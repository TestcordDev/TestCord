...
const getAudioContext = () => new (window.AudioContext || window.webkitAudioContext)({ sampleRate: 16000 });
...
export class TranscriptionWorker {
    ...
    onError;
    onPartial;
    constructor(onStatus, onComplete, onError, onPartial) {
    ...
    run(audio, model, quantized = true, language, task) {
        this.worker.postMessage({
            type: "run",
            audio,
            model,
