...
export const TranslateIcon = ({ height = 20, width = 20, className }) => (<svg viewBox="0 96 960 960" height={height} width={width} className={classes(cl("icon"), className)}>
...
export const TranslateChatBarIcon = ({ isMainChat }) => {
    ...
    const button = (<ChatBarButton tooltip="Open NativeTranslate Modal" onClick={e => {
            if (e.shiftKey)
                return toggle();
            openModal((props) => <TranslateModal rootProps={props}/>);
        }} onContextMenu={toggle} buttonProps={{ "aria-haspopup": "dialog" }}>
