...
export async function uploadFileToGofileNative(_, url, fileBuffer, fileName, fileType, token) {
    try {
...
export async function uploadFileToCatboxNative(_, url, fileBuffer, fileName, fileType, userHash) {
    try {
        const formData = new FormData();
