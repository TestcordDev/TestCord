...
export function ChatPluginCard({ url, description }) {
...
export const PluginCards = ErrorBoundary.wrap(function PluginCards({ message }) {
    const seenPlugins = new Set();
    const pluginCards = [];
    // Process embeds
    message.embeds?.forEach(embed => {
        if (!embed.url?.startsWith("https://equicord.org/plugins/") && !embed.url?.startsWith("https://vencord.dev/plugins/"))
            return;
