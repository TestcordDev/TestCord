...
export default definePlugin({
    ...
    wrapMessageAuthor({ message }, text) {
        ...
        if (message.webhookId)
            return text;
        return (<DeadIndicator channel={channel} userId={message.author.id} text={text}/>);
    },
});
const DeadIndicator = ErrorBoundary.wrap(function DeadIndicator({ channel, userId, text }) {
