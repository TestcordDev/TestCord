...
export default definePlugin({
    ...
    settings,
    toolboxActions() {
        return (<Menu.MenuItem id="auto-idle-restart-toggle-toolbox" label={settings.store.isEnabled ? "Disable Auto Idle Restart" : "Enable Auto Idle Restart"} action={() => {
    ...
    start() {
        ...
        intervalId = setInterval(() => {
            if (!settings.store.isEnabled || VoiceStateStore.isCurrentClientInVoiceChannel())
                return;
