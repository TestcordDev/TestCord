...
function AnimationSettings() {
    ...
    function updateSettingsTruthy(enabledValues) {
    ...
    return (<section>
            ...
            <div style={{ marginTop: "8px" }}>
                <SearchableSelect placeholder="Select which animations to enable..." maxVisibleItems={12} clearable={true} multi={true} value={currentValue} options={animationOptions} onChange={handleChange} closeOnSelect={false}/>
            </div>
        </section>);
}
