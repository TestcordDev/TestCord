...
export function openXRayModal(guild) {
    openModal(props => <XRayModal {...props} guild={guild}/>);
}
function XRayModal({ guild: bareGuild, ...props }) {
    ...
    return (<ModalRoot {...props} size={"large" /* ModalSize.LARGE */} className="guild-toolkit-modal">
            ...
            <TabBar type="top" look="brand" selectedItem={tab} onItemSelect={(t) => setTab(t)} className="guild-toolkit-tabbar">
