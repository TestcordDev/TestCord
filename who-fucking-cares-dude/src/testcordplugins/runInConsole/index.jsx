...
function EditCodeModal({ rootProps, close, value }) {
    const [code, setCode] = useState(value);
    return (<ModalRoot {...rootProps} className="vc-ric-modal" size={"large" /* ModalSize.LARGE */}>
            ...
            <ModalContent className={cl("modal-content-code-input")}>
                <textarea className="inputDefault_f8bc55 input_f8bc55 textArea__6e373 scrollbarGhostHairline_c858ce scrollbar_c858ce" value={code} onChange={e => setCode(e.currentTarget.value)}/>
            </ModalContent>
...
function RunCode() {
    return (<path fill="currentColor" d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm0-80h640v-400H160v400Zm187-200-76-76q-12-12-11.5-28t12.5-28q12-11 28-11.5t28 11.5l104 104q12 12 12 28t-12 28L328-308q-11 11-27.5 11.5T272-308q-11-11-11-28t11-28l75-76Zm173 160q-17 0-28.5-11.5T480-320q0-17 11.5-28.5T520-360h160q17 0 28.5 11.5T720-320q0 17-11.5 28.5T680-280H520Z"/>);
}
function EditCode() {
    return (<path fill="currentColor" d="m193-479 155 155q11 11 11 28t-11 28q-11 11-28 11t-28-11L108-452q-6-6-8.5-13T97-480q0-8 2.5-15t8.5-13l184-184q12-12 28.5-12t28.5 12q12 12 12 28.5T349-635L193-479Zm574-2L612-636q-11-11-11-28t11-28q11-11 28-11t28 11l184 184q6 6 8.5 13t2.5 15q0 8-2.5 15t-8.5 13L668-268q-12 12-28 11.5T612-269q-12-12-12-28.5t12-28.5l155-155Z"/>);
}
function RunIcon({ className, text }) {
    ...
    return (<div role="button">
            <svg viewBox="0 -960 960 960" height={16} width={16} className={classes(classNameFactory("vc-run-in-console-")("icon"), className)} onClick={() => {
            if (shift) {
                const key = openModal(props => (<EditCodeModal rootProps={props} close={() => closeModal(key)} value={text}/>));
            }
            else
                runCode(text);
        }}>
