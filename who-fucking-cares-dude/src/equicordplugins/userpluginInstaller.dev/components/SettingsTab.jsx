    ...
    title={`UserPlugins${pluginsLoaded ? ` (${plugins.length}, ${plugins.filter(p => Vencord.Settings.plugins[p.name].enabled).length} enabled)` : ""}`}>
            ...
            <Card className={cl("info-card")}>
                ...
                <div className={cl("install-field")}>
                    <CheckedTextInput onChange={t => setUrl(t)} validate={t => {
            ...
            try {
                ...
                if (e.toString().includes("silentStop"))
                    return;
                Alerts.show({
                    title: "Install error",
                    body: e.toString(),
            ...
            <div className={cl("plugins-container")}>
                ...
                return <AddonCard key={pl.name} name={pl.name} description={pl.description} enabled={rs.plugins[pl.name].enabled} infoButton={<button role="switch" onClick={async () => {
                        ...
                        if (pluginRequiresRestart(pl)) {
                            ...
                            (t ? startPlugin : stopPlugin)(pl);
                    ...
                    }} footer={(<div className={cl("plugin-footer")}>
                                ...
                                try {
                                    ...
                                    const oldPWU = userpluginInstaller.pluginsWithUpdates.value()
                                        .plugins;
