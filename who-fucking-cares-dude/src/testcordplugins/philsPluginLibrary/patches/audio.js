...
import { replaceObjectValuesIfExist } from "../../philsPluginLibrary";
export function getDefaultAudioTransportationOptions(connection) {
    return {
        audioEncoder: {
...
export function getReplaceableAudioTransportationOptions(connection, get) {
...
export function patchConnectionAudioTransportOptions(connection, get, logger) {
