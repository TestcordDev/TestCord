...
export function Validator({ link, onValidate }) {
...
export function OnlineThemesSection({ enableOnlineThemes, setEnableOnlineThemes, currentThemeLink, setCurrentThemeLink, themeLinkValid, setThemeLinkValid, addThemeLink }) {
    return (<>
            ...
            <FormSwitch title="Enable Online Themes" description="Toggle online theme loading. When disabled, all online themes will be turned off and you won't be able to add new ones." value={enableOnlineThemes} onChange={setEnableOnlineThemes}/>
            ...
            <div className={cl("link-row")}>
                <TextInput placeholder="https://example.com/theme.css" value={currentThemeLink} onChange={setCurrentThemeLink} disabled={!enableOnlineThemes}/>
                <Button onClick={() => addThemeLink(currentThemeLink)} disabled={!themeLinkValid || !enableOnlineThemes}>
                    Add
                </Button>
            </div>
            {currentThemeLink && (<div className={Margins.top8}>
