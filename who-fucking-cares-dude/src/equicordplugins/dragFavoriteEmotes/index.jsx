...
export default definePlugin({
    ...
    wrapper(emoji) {
        ...
        if (emoji?.category !== "FAVORITES")
            return;
        return (<div className={classes(cl("wrapper"), dndCls.wrapper)} aria-hidden="true">
                <div className={classes(collected.isOver ? cl("indicator") : "", dndCls.target)} ref={e => {
                ref.current = e;
                drop(e);
            }}>
                </div>
