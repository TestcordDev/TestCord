...
export function MacOSVibrancySettings() {
    ...
    return (<ErrorBoundary noop>
            ...
            <Select className={Margins.bottom20} placeholder="Window vibrancy style" options={[
        ...
        ]} select={v => settings.macosVibrancyStyle = v} isSelected={v => settings.macosVibrancyStyle === v} serialize={identity}/>
        </ErrorBoundary>);
}
