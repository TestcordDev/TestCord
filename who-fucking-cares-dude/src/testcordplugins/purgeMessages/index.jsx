...
async function deleteMessages(amount, channel, delay = 1500) {
    let deleted = 0;
    ...
    const allMessages = messagesData._array.filter((m) => m.author?.id === userId);
    const messages = [...allMessages].reverse().slice(0, amount);
    ...
    commands: [
        {
            ...
            execute: async (opts, ctx) => {
                ...
                const channel = findOption(opts, "channel", ctx.channel) || ctx.channel;
