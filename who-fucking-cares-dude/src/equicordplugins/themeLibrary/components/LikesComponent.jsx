...
export const LikesComponent = ({ themeId, likedThemes: initialLikedThemes }) => {
    ...
    return (<Button onClick={() => handleLikeClick(themeId)} variant="secondary" size="medium" disabled={themeId === "preview"} className={Margins.right8}>
