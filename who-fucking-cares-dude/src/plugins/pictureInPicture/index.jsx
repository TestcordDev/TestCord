...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: (_, rest, origChildren, mimeType, downloadURL, showDownload, isVisualMediaType) => `${rest}[${showDownload}&&${isVisualMediaType}&&$self.shouldShowButton(${mimeType},${downloadURL})&&$self.PictureInPictureButton(),...${origChildren}]`
            }
        }
    ],
    shouldShowButton(mimeType = [], downloadURL) {
    ...
    PictureInPictureButton: ErrorBoundary.wrap(() => {
        return (<Tooltip text="Toggle Picture in Picture">
                {tooltipProps => (<div {...tooltipProps} className="vc-pip-button" role="button" style={{
                    cursor: "pointer",
                    paddingTop: "4px",
                    paddingLeft: "4px",
                    paddingRight: "4px",
                    ...
                    const videoClone = document.body.appendChild(video.cloneNode(true));
