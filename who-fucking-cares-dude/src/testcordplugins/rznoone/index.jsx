...
let pinnedChannelId = null; // Store pinned channel ID
...
function addPinChannelContextMenu(children, { channel }) {
    if (!channel || channel.type !== 2)
        return;
    children.push(<Menu.MenuItem id="pin-channel" label={pinnedChannelId === channel.id ? "Unpin Channel" : "Pin to Channel"} action={() => {
