...
const SilentMessageIcon = ({ height = 20, width = 20, className, children }) => {
    return (<svg width={width} height={height} viewBox="0 0 24 24" className={className} style={{ scale: "1.2" }}>
...
const SilentMessageToggle = ({ isMainChat }) => {
    ...
    if (!isMainChat)
        return null;
    return (<ChatBarButton tooltip={enabled ? "Disable Silent Message" : "Enable Silent Message"} onClick={() => setEnabledValue(!enabled)}>
