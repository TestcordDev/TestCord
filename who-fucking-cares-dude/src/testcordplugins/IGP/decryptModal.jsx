...
function DecryptModal(props) {
    return (<ModalRoot {...props} size={"large" /* ModalSize.LARGE */}>
            ...
            <ModalContent>
                ...
                <TextArea value={props.message} disabled={true} rows={Math.max(5, props.message.split("\n").length + 1)} onChange={() => props.message}/>
            </ModalContent>
        </ModalRoot>);
}
export function buildDecryptModal(decryptedMessage, verified) {
