...
function migrateStickerPackId(oldStickerPackId) {
...
function migrateStickerId(oldStickerId) {
...
function migrateSticker(oldSticker) {
    return {
        ...oldSticker,
        id: migrateStickerId(oldSticker.id),
    };
}
function migrateStickerPack(oldStickerPack) {
    return {
        ...oldStickerPack,
