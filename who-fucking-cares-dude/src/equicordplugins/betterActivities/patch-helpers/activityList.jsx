...
export function patchActivityList({ activities: rawActivities, user, hideTooltip }) {
    const icons = [];
    if (user.bot || settings.store.hideTooltip && hideTooltip)
        return null;
    const activities = rawActivities?.filter((a) => a != null) ?? [];
