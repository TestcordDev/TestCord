    ...
    registerCommand({
        ...
        execute: async (args, { channel }) => {
            ...
            const response = tag.message
                .replace(ArgumentRegex, (fullMatch, value) => {
