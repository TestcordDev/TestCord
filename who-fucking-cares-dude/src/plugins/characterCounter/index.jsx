...
function getCounterColor(percentage) {
    if (!settings.store.colorEffects)
        return "var(--primary-330)";
    if (percentage < 50)
        return "var(--text-muted)";
    if (percentage < 75)
        return "var(--yellow-330)";
    if (percentage < 90)
        return "var(--orange-330)";
    return "var(--red-360)";
}
export default definePlugin({
    ...
    renderCharCounter: ErrorBoundary.wrap(({ editorRef, text }) => {
        ...
        return (<div className={cl("counter")} style={{ color }}>
                {showSelected && (<>
