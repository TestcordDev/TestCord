...
const ReplacedStreamSettings = () => {
    ...
    return (<div style={{ margin: "1em", display: "flex", flexDirection: "column", gap: "1em" }}>
            ...
            <SettingsModalCard cardProps={cardProps} switchEnabled switchProps={{
...
export function replacedSubmitFunction(fn) {
    return (...args) => {
...
export function GoLivePanelWrapper({ children }) {
    if (!children)
        return;
