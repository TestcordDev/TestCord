...
export const settings = definePluginSettings({
    ...
    importGifs: {
        ...
        component: () => <Button onClick={async () => (await getCollections()).length ? Alerts.show({
                title: "Are you sure?",
    ...
    exportGifs: {
        ...
        component: () => <Button onClick={downloadCollections}>
                Export Collections
            </Button>,
    },
    resetCollections: {
...
function RadioOption({ name, value, checked, onChange, label }) {
    return (<div className={cl("sort-option")}>
...
function SortSettingsComponent() {
    ...
    return (<div className={cl("sort-container")}>
