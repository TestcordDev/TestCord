...
const setCssDebounced = debounce((css) => VencordNative.quickCss.set(css));
...
window.VencordNative = {
    ...
    settings: {
        ...
        set: async (s) => localStorage.setItem("EquicordSettings", JSON.stringify(s)),
    ...
    presets: {
        ...
        set: async (data) => localStorage.setItem("VencordPresets", JSON.stringify(data)),
    },
    pluginHelpers: {},
    privacy: {},
    csp: {},
