...
import { countMessagesByStatusIDB, countMessagesIDB, DBMessageStatus, getDateStortedMessagesByStatusIDB } from "../db";
...
// this is so shit
export function useMessages(query, currentTab, sortNewest, numDisplayedMessages) {
