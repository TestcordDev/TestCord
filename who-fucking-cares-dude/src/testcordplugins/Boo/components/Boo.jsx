...
export default function Boo({ channel }) {
    const { id } = channel;
    ...
    if (!state.isDataProcessed || !currentUserId || !lastMessage)
        return null;
    return (!state.isCurrentUser && (<div className={ChannelWrapperStyles.wrapper}>
