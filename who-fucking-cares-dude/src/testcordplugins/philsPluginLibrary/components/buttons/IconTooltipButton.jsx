...
export const IconTooltipButton = (props) => {
    return (<Tooltip text={props.tooltipText}>
            {tooltipProps => <Button size={Button.Sizes.MIN} {...props} style={{ aspectRatio: 1, maxHeight: "32px", boxSizing: "border-box", ...props.style }}>
