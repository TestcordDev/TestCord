...
const FetchTimeButton = ({ isMainChat }) => {
    ...
    return (<ChatBarButton tooltip={`Messages loaded in ${Math.round(time)}ms (${timeAgo})`} onClick={() => { }}>
            <div style={{
            display: "flex",
            alignItems: "center",
            gap: "4px"
...
function handleChannelSelect(data) {
