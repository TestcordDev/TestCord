...
function micSettingsButton() {
    ...
    if (hideSettingsIcon)
        return null;
    return (<Button tooltipText="Change screenshare settings" icon={MicrophoneSettingsIcon} role="button" onClick={openMicrophoneSettingsModal}/>);
}
...
export default definePlugin({
    name: "BetterMicrophone", hidden: true,
