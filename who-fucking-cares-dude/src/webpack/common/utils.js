...
export function createToast(message, type, options) {
    return {
        message,
        id: Toasts.genId(),
        type,
...
export const UploadHandler = {
    promptToUpload: findByCodeLazy("Unexpected mismatch between files and file metadata")
};
...
export const URLUtils = findByPropsLazy("URL_REGEX", "makeUrl", "isDiscordUrl");
export const Humanize = findByPropsLazy("filesize", "relativeTime", "ordinal");
export const EmojiUtils = findByPropsLazy("getEmojiColors", "getURL");
