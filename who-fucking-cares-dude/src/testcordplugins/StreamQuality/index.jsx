...
function patchDesktopSourceOptions(options) {
...
function onConnection(connection) {
    ...
    if (connection.streamUserId && connection.streamUserId !== UserStore.getCurrentUser()?.id)
        return;
    ...
    if (origSetStreamParameters) {
        connection.conn.setStreamParameters = function (options) {
    ...
    if (connection.videoQualityManager) {
        ...
        vqm.getDesktopQuality = function (...args) {
        ...
        vqm.applyQualityConstraints = function (...args) {
        ...
        if (typeof vqm.setQuality === "function") {
            ...
            vqm.setQuality = function (quality, ...rest) {
