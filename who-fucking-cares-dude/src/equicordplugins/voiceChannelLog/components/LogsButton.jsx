...
function LogIcon({ height = 24, width = 24 }) {
...
export function OpenLogsButton() {
    ...
    if (!channel)
        return null;
    return (<HeaderBarButton className={cl("toolbar-btn")} onClick={() => openVoiceChannelLog(channel)} tooltip="Voice Channel Logs" icon={LogIcon}/>);
}
export { LogIcon };
